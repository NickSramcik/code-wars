...
// If both inputs are not postitive numbers, throw an error
// Square root the sum of the inputs squared and round it to 3 decimal places
// Return result

function calculateHypotenuse(a, b) {
    if ((!(a >= 0) || !(b >= 0)) || typeof a == 'boolean' || typeof b == 'boolean') throw Error;
