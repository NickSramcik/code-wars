...
// Journey constructor
// Args:
//      object (object with weight property (number))
//      crew (number)
//      balloons (number)
// Methods:
//      isPossible() -> return bool, whether object weight + crew weight < balloon lift

// Crew weight: 80kg per person
// Balloon lift: 4.8g = 0.0048 kg per balloon
// Object weight is in kg
...
class Journey {
    ...
    isPossible() {
        return this.object.weight + this.crew * Journey.CREW_WT < this.balloons * Journey.LIFT;
    }
}
