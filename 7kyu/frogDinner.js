// in the below problem - the highest n can be is 200.
...
// Store three values as follows:
// chris: gauss summation of input n
// tom: gauss summation of chris(floored) / 2
// cat: gauss summation of tom + chris
...
function frogContest(n) {
    const chris = sum(n);
    const tom = sum(Math.floor(chris / 2));
    const cat = sum(tom + chris);
