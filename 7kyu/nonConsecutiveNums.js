...
// Pass in an array of nums
// Return an array of objects

// Let result be an empty array
// Loop through the input array (begin index 1) 
//   If current num does NOT equal previous num + 1
//       Push {i: index, n: currentNum} to result
// Return result
...
// Refactored using map and filter
// Fun but not readable 😔

function allNonConsecutive (arr) {
    return arr.map((n, i) => ({i, n})).filter((obj, j, a) => j && obj.n - 1 !== a[j - 1].n);
}
