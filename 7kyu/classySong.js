...
// class Song
// args: title, artist
// store: listener object
// methods: howMany -> pass in array, return number, amount of listeners not already present in listener obj
...
class Song{
    ...
    howMany(arr) {
        ...
        for (let name of arr) {
            // Lowercase the listener name for case insensitivity
