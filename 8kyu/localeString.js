...
// take in 3 positive integers (rgb) from 0-255
// Convert those inputs to a hexadecimal string and return
// 255, 0, 0 -> '#ff0000'

// Convert each input to a string, base 16, using .toString(16)
// Concat each string with a # in front and return
...
function colorOf(r,g,b) {
    r = leadingZero(r.toString(16));
    g = leadingZero(g.toString(16));
    b = leadingZero(b.toString(16));
    return '#' + r + g + b;
  }


// Refactored using padStart

const toHex = s => s.toString(16).padStart(2, 0);
