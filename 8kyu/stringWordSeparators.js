...
// Pass in 2 arguments: a string and a separator
// Return the string with the separator inbetween each character (ignore spaces)

// 'Ogres are like onions', '!' -> 'O!g!r!e!s! a!r!e l!i!k!e o!n!i!o!n!s' 

// Split the string into an array, split each element and join it back with the separator, join back into words. 
