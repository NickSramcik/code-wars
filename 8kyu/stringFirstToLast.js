...
// Pass in a string and character c (string with length 1) 
// Return the gap between the first c and the last c
// 'ogres are like onions' -> 15

// Subtract the last index of c from the first index of c
// If str doesn't include c, return -1
